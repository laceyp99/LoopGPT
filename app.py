...
def run_loop(key, scale, description, temp, model_choice, translate_prompt_choice, show_visual, openai_key, gemini_key, claude_key):
    ...
    elif model_choice in ["claude-3-5-sonnet-latest", "claude-3-5-sonnet-20240620", "claude-3-5-haiku-latest", "claude-3-haiku-20240307"]: # "claude-opus-4-20250514","claude-sonnet-4-20250514", "claude-3-7-sonnet-latest", 
        if translate_prompt_choice:
